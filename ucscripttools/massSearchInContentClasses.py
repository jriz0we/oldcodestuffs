...
def main():
    ...
    if not (options.search):
        parser.error("must specifiy search flags")
    #if options.verbose:
    #    print "reading %s..." % options.filename
    print "searching for %s in uc files" % \
        (options.search)
...
# KActorSpawnable'offc_chair_a.Destructibles.Offc_ChairAKnockC_Arch'# StaticMesh'offc_chair_a.Destructibles.Offc_Chair_A_Destroyed_Knock_C'
